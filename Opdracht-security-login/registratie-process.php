<?php 
	...
	{	
		...
		else
		{
			...
			{
				$userExistsError = new Notification("De gebruiker met het e-mailadres " . $email . "komt reeds voor in onze database."); 
			...
			else
			{
				...
				if ($newUser)
				{
					$registrationSuccess = new Notification("Welkom, u bent vanaf nu geregistreerd in onze app.");
